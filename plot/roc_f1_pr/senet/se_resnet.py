...
class FineTuneSEResnet50(nn.Module):
    def __init__(self, num_class=10, pretrained=True):
        super(FineTuneSEResnet50, self).__init__()
        self.num_class = num_class
        seresnet50 = se_resnet50(pretrained=pretrained)
        self.features = nn.Sequential(*list(seresnet50.children())[:-1])
...
if __name__ == '__main__':
    se_resnet = se_resnet50(1000,True)
    print(se_resnet)
